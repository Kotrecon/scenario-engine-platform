...
**Реализовано.** Заголовок `X-Correlation-Id` автоматически генерируется (Guid.CreateVersion7) или прокидывается из входящего запроса. Доступен в логах и OTel-трейсах.
